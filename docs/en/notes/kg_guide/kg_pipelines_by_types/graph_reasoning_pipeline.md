...
- Pipeline script: `api_pipelines/graph_reasoning_pipeline.py`
- Default data: `example_data/GraphReasoningPipeline/input.json`
...
The default model is `gpt-4o-mini`. You can override the defaults with `DF_API_URL`, `DF_LLM_MODEL`, or `DF_GRAPH_REASONING_INPUT_FILE`.
