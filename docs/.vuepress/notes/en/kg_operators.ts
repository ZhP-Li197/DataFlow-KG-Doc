...
=======
  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: false,
          prefix: 'filter/',
          items: ['tkg_4tuple_time_sampling'],
        },
        {
          text: 'eval',
          collapsed: false,
          prefix: 'eval/',
          items: ['tkg_4tuple_time_summary'],
        },
        {
          text: 'refine',
          collapsed: false,
          prefix: 'refine/',
          items: ['tkg_4tuple_disambiguation'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: false,
          prefix: 'generate/',
          items: ['audio_caption', 'silero_vad'],
        },
        {
          text: 'eval',
          collapsed: false,
          prefix: 'eval/',
          items: ['ctc_forced_aligner_eval'],
        },
        {
          text: 'filter',
          collapsed: false,
          prefix: 'filter/',
          items: ['ctc_forced_aligner_filter'],
        },
        {
          text: 'generaterow',
          collapsed: false,
    ...
    },
    {
      ...
      icon: 'carbon:idea',
      prefix: 'image_video_generation',
      items: ['install_image_video_generation', 'image_generation'],
    },
  ],
>>>>>>> main
})
